...
public class DashBoard extends javax.swing.JFrame {
    ...
    public DashBoard() {
      ...
      void girisResult(){
        ...
        try {
            ...
            String query = "SELECT * FROM `uyeler` WHERE kadi = ? , sifresi = ?";
            PreparedStatement pre = db.preBaglan(query);
            pre.setString(1, ad);
            pre.setString(2, sifre);
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Kullanıcı Kayıt", jPanel1);
